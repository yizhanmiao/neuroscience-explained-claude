...
begin
	...
	This notebook, generated by Claude Code, walks you through two foundational tools for studying **neural population activity**:
...
begin
    ...
    plot(p_raster_a, p_raster_b; layout=(1, 2))
end
...
---
*Built with Claude · Julia · Pluto.jl · Plots.jl*
"""
...
manifest_format = "2.0"
project_hash = "faa0a7c4b5e0ed203a049e8bfd247a9e47c144db"
